...
<head>
  ...
  <!-- Tiny -->
  <script src="https://cdn.tiny.cloud/1/l3lf2cxfglnijsamtrlsbaot8g2syf94u69z3o91holdp4qr/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
  {{-- <script src="{{asset('admin/tinymce/tinymce.min.js')}}"></script> --}}

  <!-- Validation -->
  <link rel="stylesheet" href="{{asset('admin/css/validation.css')}}">
  <link rel="stylesheet" href="{{asset('admin/css/style.css')}}">
  <link rel="stylesheet" href="{{asset('admin/css/validator.css')}}">
...
{{-- <script src=" https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" > </script> --}}
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var pusher = new Pusher('148f634240b6ffbb39cb', {
                cluster: 'ap1',
                forceTLS: true
            });
