...
@endsection
@section('content')
        <form id="form-edit" style="padding: 8px 8px; border-radius: 4px" role="form" method="post" action="{{route('news.update')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input id="title" class="form-control" placeholder="Tiêu đề" type="text" name="title" value="{{$news->title}}">
            ...
            <div class="form-group">
                ...
                <input id="poster" class="form-control" placeholder="Người đăng" type="text" name="poster" value="{{$news->poster}}">
                <span class="form-message"></span>
                @error('poster')
                    <span class="error">{{$message}}</span>
                @enderror
            ...
            <div class="form-group">
                ...
                <textarea id="summary" class="form-control" name="summary">{!!$news->summary!!}</textarea>
                <span class="form-message"></span>
                @error('summary')
                    <span class="error">{{$message}}</span>
                @enderror
        ...
        <div class="col-md-3">
            ...
            <div class="col">
                <img src="{{url('admin/photo/news',$news->photo)}}" alt="photo" height="100" width="100%" id="preview">
            </div>
            <br>
            <div class="col">
                <div class="form-group">
