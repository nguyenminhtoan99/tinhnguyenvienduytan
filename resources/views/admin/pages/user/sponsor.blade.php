...
@endsection
@section('content')
    <form style="padding: 8px 8px; border-radius: 4px" role="form" class="form" method="post" action="{{route('sponsor.doneparse', $user->id)}}" enctype="multipart/form-data" id="form-add-sponsor">
            @csrf
        <div class="row container-fluid">
                    <div class="tabbable-custom" style="background-color: white; border: 1px solid #ddd; border-radius: 4px; padding: 15px;">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="fullname"  type="text" name="name" value="{{$user->name}}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="emaill" type="text" name="email" value="{{$user->email}}">
                            <span class="form-message"></span>
                            @error('email')
                                <span class="error">{{$message}}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="amount_financed" type="text" name="amount_financed" value="{{old('amount_financed')}}">
                            <span class="form-message"></span>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Nặc danh</label>
